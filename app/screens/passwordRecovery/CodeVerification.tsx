...
export default function CodeVerification() {
    const valInput = 'text-[25px] text-center border-2 w-[15%] h-[15vw] rounded-md bg-light-secondary border-light-fourth';
    return (
        <View className='bg-light-primary h-full flex justify-center px-[8%] gap-6'>
            <Text className='text-center text-light-secondary text-[28px] font-[600]'>Verificacion de codigo</Text>
